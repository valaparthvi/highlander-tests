...
var _ = Describe("ProvisioningGke", func() {
	...
	When("a cluster is created", func() {
		...
		BeforeEach(func() {
			...
			//	TODO: Could add a line to fetch the cluster again once it's ready so that it has everything up to date. For e.g. once the cluster has been updated, it contains information such as Version.GitVersion which it does not have before it's ready
		})
		AfterEach(func() {
